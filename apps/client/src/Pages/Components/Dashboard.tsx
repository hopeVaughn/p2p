...
export default function SignupRegister({ children }: DashboardProps) {
  return (
    <>
      {/*
      ...
      */}
      <div className="min-h-full">
        <div className="bg-cyan-700 pb-32">
          <Disclosure as="nav" className="border-b border-indigo-300 border-opacity-25 bg-orange-100 lg:border-none">
            {({ open }) => (
              <>
        ...
        <main className="-mt-32 flex-1">
          <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8 flex flex-col">
            <div className="rounded-lg bg-white px-5 py-6 shadow sm:px-6 flex-1 flex flex-col">{children}</div>
          </div>
        </main>
      </div>
    </>
